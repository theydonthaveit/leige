...
const SEQUELIZE = new Sequelize('rq3hoz8ohqisvvyg', 'nnxe18q6mvntor4e', 'khzozefo4x7fql11', {
...
const PROFILE_URLS = SEQUELIZE.define('ProfileUrls', {
    user_id: {
...
const GAMESCLASS = SEQUELIZE.define('GameClass', {
    title: {
        type: Sequelize.STRING
    },
    nameVariant: {
...
//     }
// )
const LIVEGAMES = SEQUELIZE.define('LiveGames', {
...
exports.default = { USER, PROFILE_URLS, LIVEGAMES, GAMESCLASS };
